  ...
  return (
    <main className="admin-shell" dir={locale === "ar" ? "rtl" : "ltr"} lang={locale}>
      ...
      <section className="admin-main">
        ...
        <details className="admin-shop-day no-print" key={activeView === "day" ? "day" : "collapsed"} open={activeView === "day" || undefined}><summary>{tr(locale,"Shop day · opening / closing","يوم العمل · الافتتاح / الإغلاق")}</summary><BusinessDayPanel locale={locale} refreshKey={data} onChange={() => void load()} /></details>
